...
> Hệ thống hỗ trợ lưu trữ vector kèm theo Metadata đầy đủ. Trong quá trình tìm kiếm, ngoài việc trả về nội dung tương đồng, hệ thống còn trả về toàn bộ "chứng minh thư" (Metadata) của đoạn văn đó. Điều này cho phép Agent không chỉ trả lời câu hỏi mà còn có thể chỉ ra chính xác nguồn trích dẫn từ văn bản gốc, tăng tính minh bạch cho câu trả lời.
